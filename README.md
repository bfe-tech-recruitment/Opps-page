...
## Remove a posting
Put your post into `_posts\archived`. Read [here](https://docs.github.com/en/github/managing-files-in-a-repository/moving-a-file-to-a-new-location) on how to change the file path.
## Original template
